...
public class AddressVerifyReq {
	 ...
	 */
	public void setAddressVerifyRequest(
			AddressVerifyRequestType addressVerifyRequest) {
	...
	public String toXMLString(String prefix, String name) {
		...
		if (addressVerifyRequest != null) {
			sb.append(addressVerifyRequest.toXMLString(null,
		...
		if (name != null) {
			if (prefix != null) {
				...
				sb.append("</").append(preferredPrefix).append(":")
						.append(name).append(">");
			}
		}
		return sb.toString();
